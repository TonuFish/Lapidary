...
{
	/* const */
	internal byte* netldiHostOrIp;
	/* const */
	internal byte* netldiNameOrPort;
	/* const */
	internal byte* privateKey;
	/* const */
	internal byte* cert;
	/* const */
	internal byte* caCert;
	/* const */
	internal byte* extraGemArgs;
	/* const */
	internal byte* dirArg; // #dir
	/* const */
	internal byte* logArg; // #log
