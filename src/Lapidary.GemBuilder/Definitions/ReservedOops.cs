...
/// gcioop.ht
/// </summary>
internal unsafe static class ReservedOops
{
    ...
    internal static class SpecialClassTags
    {
        ...
        public const Oop Character = 0x1C;
        public const Oop JisCharacter = 0x24;
        public const Oop SmallFraction = 0x2C;
        public const Oop SmallScaledDecimal = 0x34;
        public const Oop SmallDateAndTime = 0x3C;
        public const Oop SmallTime = 0x44;
        public const Oop SmallDate = 0x4C;
    }

    public const Oop OOP_TAG_RAM_OOP = 0x0UL; /* 2r000  memory pointer ObjSType* */
    public const Oop OOP_TAG_POM_OOP = 0x1UL; /* 2r001  disk objId */
